...
class MetodaMonte(QDialog):
    ...
    def initUI(self):
        ...
        labels_2 = [
            ...
            "Tak samo jak 1D opiera się ona na losowych próbkach, jednak tym razem w dwóch wymiarach.",
        ...
        l4 = QLabel("Wyznacza się przez średnią wartość całki f(x) z zakresu a≤x≤b. Aby wyznaczyć średnią, "
                    "losowo wybieramy próbki x<sub>i</sub> o regularnych odstępach. ")
        ...
        l8 = QLabel(
            "Mamy daną powierzchnię A. Losowo wybieramy punkty n o współrzędnych (x<sub>i</sub>, y<sub>i</sub>) ")
